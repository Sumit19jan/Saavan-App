...
public class BrowseViewHolder extends RecyclerView.ViewHolder {
    ...
    private void initViews(View itemView) {
        IvSongImage=itemView.findViewById(R.id.ivBrowse);
        tvTitle=itemView.findViewById(R.id.tvBrowseTitle);
        ConstraintContainer=itemView.findViewById(R.id.browseContainer);
