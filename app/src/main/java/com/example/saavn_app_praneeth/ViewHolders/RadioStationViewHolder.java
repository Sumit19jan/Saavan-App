...
public class RadioStationViewHolder extends RecyclerView.ViewHolder {
    ...
    public RadioStationViewHolder(@NonNull View itemView) {
        super(itemView);
        initViews(itemView);
    }

    private void initViews(View itemView) {
        IvSongImage=itemView.findViewById(R.id.ivRadioStationSongs);
        tvTitle=itemView.findViewById(R.id.tvRadioStationTitle);
        ConstraintContainer=itemView.findViewById(R.id.radioStationsContainer);
