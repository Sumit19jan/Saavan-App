...
public class SearchFragmentViewHolder extends RecyclerView.ViewHolder {
    ...
    private void initViews(View itemView) {
        IvSongImage=itemView.findViewById(R.id.ivSearchFragment);
        tvTitle=itemView.findViewById(R.id.tvSearchFragmentTitle);
        ConstraintContainer=itemView.findViewById(R.id.searchFragmentContainer);
    }
